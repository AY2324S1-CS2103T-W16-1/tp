...
with(this){return _c('ul',[_c('li',[_v("Deletes one or more tags to a contact, regardless if the tag exists in the contact or not.")]),_v(" "),_c('li',[_v("Duplicates are accepted.")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TAGNAME")]),_v(" must be alphanumeric, with no spaces.")])])}
},function anonymous(
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Thu, 9 Nov 2023, 20:38:46 GMT+8]")])])])}
}];
